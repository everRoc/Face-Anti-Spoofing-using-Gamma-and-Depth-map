...
from Load_data_test1 import Spoofing_test1, Normaliztion, ToTensor
...
if __name__ == "__main__":
    ...
    parser.add_argument('--path', type=str, default="E:/dataset/testoulu/A_test1", help='test_data_path')
...
################# crop face#############################
    ...
    with torch.no_grad():
        ...
        val_data = Spoofing_test(test_face_path,
        ...
        for i, sample_batched in enumerate(dataloader_val):
            #             # get the inputs
            inputs, binary_mask, spoof_label = sample_batched['image_x'].cuda(), sample_batched['binary_mask'].cuda(), \
...
#   1.所要求输出为csv文件，每行为图片id及对应置信度
#   2.label问题，我们的图片label由图片id得来（Loadtemporal_BinaryMask_train1），助教测试可能会用label list
